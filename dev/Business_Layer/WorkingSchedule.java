...
public class WorkingSchedule {
    ...
    public boolean addWorkersToShift(String role, Employee e){
    ...
    private boolean employeeCanWork(Employee e){
    ...
    private boolean shiftContainsEmployee(Employee e)
    {
        for (int i = 0; i<employeeList.size(); i++)
        {
    ...
    public boolean changeEmployeeRole(Employee e, String role) {
